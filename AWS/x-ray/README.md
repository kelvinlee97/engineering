...
It shows the full request path through your front end, microservices, databases, and downstream AWS APIs, helping you identify bottlenecks, latency spikes, and errors.
