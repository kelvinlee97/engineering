...
> AWS CodeStar 是一个已退役的产品，而不是带宽限期的弃用功能：自 2024 年 7 月 31 日起控制台和 SDK 已完全消失，本文的作用只是帮助团队识别遗留的 CodeStar 资源，并将其迁移到 CodeCatalyst 或直接迁移到底层的 Code 系列服务。

本文主要回答一个问题：

1. 手上还有旧 CodeStar 资源的团队，现在应该怎么做？
