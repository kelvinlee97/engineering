...
The AWS Well-Architected Tool (AWS WA Tool) provides a consistent process to document decisions, answer review questions, and get recommendations for improvement across the six pillars.
