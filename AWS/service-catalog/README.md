...
> AWS Service Catalog lets organizations create and manage catalogs of approved IT services, from single resources (AMI-based servers, databases, software) to complete multi-tier application architectures.

## Overview

Administrators assemble portfolios with constraints and access control; end users discover and self-service provision only the approved products.
