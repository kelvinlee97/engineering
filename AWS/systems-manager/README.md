...
Nodes run the SSM Agent and are registered as managed nodes; you then use tools like Run Command, Session Manager, Patch Manager, Parameter Store, Automation, and OpsCenter without logging into servers.
