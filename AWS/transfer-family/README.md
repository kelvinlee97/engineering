...
You keep your existing clients, authentication, and firewall configurations; AWS manages the servers and scales them automatically. You pay only for what you use.
