---
type: Source Summary
title: AWS Secrets Manager runbook and reference (summary)
description: Summary of the legacy AWS runbook and reference note for AWS Secrets Manager, verified against AWS documentation on 2026-08-19.
tags: [aws, reference]
sources:
