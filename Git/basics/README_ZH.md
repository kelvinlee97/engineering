...
| 顺序 | 命令 | 一句话理解 | 链接 |
|---|---|---|---|
| 1 | `git init` | 把一个普通文件夹变成 Git 仓库 | [../init](../init/README_ZH.md) |
| 2 | `git clone` | 把远程仓库完整复制到本地 | [../clone](../clone/README_ZH.md) |
| 3 | `git add` | 把改动放进"待提交"暂存区 | [../add](../add/README_ZH.md) |
| 4 | `git status` | 看清当前工作区/暂存区的状态 | [../status](../status/README_ZH.md) |
| 5 | `git commit` | 把暂存区内容打包成一次历史快照 | [../commit](../commit/README_ZH.md) |
| 6 | `git log` | 查看提交历史 | [../log](../log/README_ZH.md) |
| 7 | `git diff` | 对比两个版本之间的具体差异 | [../diff](../diff/README_ZH.md) |
...
准备好了就从第一站开始 👉 [Git/init —— 创建你的第一个仓库](../init/README_ZH.md)
